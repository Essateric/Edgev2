...
serve(async (req: Request) => {
  ...
  try {
    ...
    const SUPABASE_URL = (Deno.env.get("SUPABASE_URL") || "❌ Missing SUPABASE_URL").trim();
    const SERVICE_ROLE_KEY = (Deno.env.get("SUPABASE_SERVICE_ROLE_KEY") || "❌ Missing SERVICE_ROLE_KEY").trim();
