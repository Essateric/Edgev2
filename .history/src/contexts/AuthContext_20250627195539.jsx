...
console.log("🚀 Function Secret being sent:", `Bearer ${import.meta.env.VITE_FUNCTION_SECRET}`);
      ...
      const res = await fetch(
        "https://vmtcofezozrblfxudauk.functions.supabase.co/generate-supabase-token",
        {
          ...
          headers: {
            ...
            "Authorization": `Bearer ${import.meta.env.FUNCTION_SECRET}`, // ✅ Correct Bearer header
          },
