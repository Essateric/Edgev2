...
export const AuthProvider = ({ children }) => {
  ...
  console.log("👉 Function Secret:", import.meta.env.VITE_FUNCTION_SECRET);
  ...
  const loginWithPin = async (pin) => {
   ...
   console.log("👉 Sending Function Secret:", import.meta.env.VITE_FUNCTION_SECRET.trim());
...
const res = await fetch(
  "https://vmtcofezozrblfxudauk.functions.supabase.co/login-with-pin",
  {
    ...
    headers: {
      ...
      Authorization: `Bearer ${import.meta.env.VITE_FUNCTION_SECRET.trim()}`,
    },
    body: JSON.stringify({ pin }),
      ...
      // ✅ Exchange custom JWT token with Supabase session
      ...
      setCurrentUser({ ...user, offline: false });
