...
export default function AddNewStaffModal({ open, onClose, onSaved }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 🟢 Send magic link if email provided and staff was created
if (form.email && data && !data.error) {
  await fetch("https://vmtcofezozrblfxudauk.functions.supabase.co/send-magic-link", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      // If your send-magic-link function requires auth, add:
