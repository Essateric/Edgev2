...
export default function NewBooking({
  ...
  const end = new Date(
    selectedSlot?.start.getTime() + totalDuration * 60000 || 0
  );
    ...
    <div className="w-full h-full flex flex-col p-4">
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-gray-700">
          {format(start, "eeee dd MMM yyyy")} • {format(start, "HH:mm")} -{" "}
          {format(end, "HH:mm")}
        </p>
      ...
      {/* Main Grid */}
      <div className="flex-1 grid grid-cols-1 md:grid-cols-3 gap-4 overflow-auto">
        {/* Categories */}
