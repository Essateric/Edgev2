...
const stylist = staff?.find(s => s.id === booking?.resource_id);


if (!stylist) {
  console.warn('⚠️ Stylist not found for resourceId:', booking.resource_id);
} else {
  ...
  return (
    ...
    <p><strong>Stylist:</strong> {stylist?.name || 'Unknown'}</p>
