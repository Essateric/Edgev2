...
import { useAuth } from "../contexts/AuthContext"; // ✅ Use your Auth Context for token
...
export default function AddNewStaffModal({ open, onClose, onSaved }) {
  ...
  const { currentUser } = useAuth(); // ✅ Get token from your Auth Context
      ...
      const res = await fetch(
        "https://vmtcofezozrblfxudauk.supabase.co/functions/v1/addnewstaff",
        {
          ...
          headers: {
            ...
            Authorization: `Bearer ${currentUser.token}`, // ✅ Use JWT from AuthContext
          },
          body: JSON.stringify({
            name: form.name,
