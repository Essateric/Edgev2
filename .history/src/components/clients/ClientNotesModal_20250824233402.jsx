    ...
    (async () => {
      ...
      if (ids.length) {
        ...
        if (!staffErr) {
          const map = {};
          (staffRows || []).forEach((s) => {
            // Prefer 'name'; fallback to email or permission
        ...
        <div>
          ...
          {!isEditingEmail ? (
            <div className="flex items-center gap-2 text-sm">
              <span className="flex-1">{client?.email || <span className="text-gray-500">No email</span>}</span>
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <Button onClick={handleSaveEmail} disabled={savingEmail} className="text-sm">
