...
export default function PinPad({ onChange, value = "", onEnter, disabled }) {
  ...
  const renderButton = (label, onClick, extraClass = "") => (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className={`w-20 aspect-square text-white font-semibold rounded-xl shadow-md
  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-h-[70vh] overflow-hidden">
      {/* PIN Dots */}
