...
<Modal isOpen={isModalOpen && step === 1} onClose={handleCancel}>
  ...
  <div className="mb-4 text-sm text-gray-700">
    <p className="font-semibold mb-1">Selected Time:</p>
    <p>
  ...
  <Select
    ...
    value={
      clientOptions.find((opt) => opt.value === selectedClient) || null
    }
...
<RightDrawer isOpen={step === 2} onClose={handleModalCancel}>
  <NewBooking
    ...
    onConfirm={(newEvents) => {
      ...
      setIsModalOpen(false);
      setStep(3); // Move to review step after selecting services
    }}
  />
</RightDrawer>
