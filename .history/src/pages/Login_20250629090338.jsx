...
export default function Login() {
 ...
 return (
  <div className="flex justify-center items-center h-screen bg-gradient-to-br from-black via-zinc-900 to-bronze relative">
    ...
    {/* Outer Bronze Gradient Border
    <div className="bg-gradient-to-br from-[#b57f3d] via-[#cd7f32] to-[#a86a1f] 
        p-[2px] rounded-3xl shadow-2xl"> */}
      
      {/* Inner Card */}
      <div className="w-full max-w-md z-10 bg-black bg-opacity-80 
        shadow-xl rounded-3xl flex flex-col items-center p-8 relative">
