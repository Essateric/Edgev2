      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-2 border-black">
          ...
          <button
            ...
            className="bg-gray-200 px-3 py-1 rounded hover:bg-gray-300"
          >
            <ChevronRight className="w-8 h-8 text-black border-black" />
          </button>

          {/* 📅 Go to Date */}
          <button
            onClick={() => setIsCalendarOpen(true)}
            className="bg-bronze border-black hover:bg-black text-white px-3 py-1 rounded flex items-center gap-1 p-5"
          >
