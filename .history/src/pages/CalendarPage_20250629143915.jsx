...
export default function CalendarPage() {
  ...
  className="bg-gray-200 px-4 py-2 rounded-lg border border-black hover:bg-black hover:text-white"
>
  Today
</button>
          {/* ⬅️ Back */}
          ...
          <button
            ...
            className="bg-bronze border border-black  hover:bg-black text-white px-3 py-1 rounded flex items-center gap-1 p-5"
          >
            <CalendarIcon className="w-4 h-4" />
            <span className="text-">Go to Date</span>
          </button>
        </div>
      </div>
